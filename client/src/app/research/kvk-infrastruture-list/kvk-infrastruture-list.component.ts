...
@Component({
  selector: 'app-kvk-infrastruture-list',
  standalone: false,
  templateUrl: './kvk-infrastruture-list.component.html',
  styleUrls: ['./kvk-infrastruture-list.component.scss']
})
export class KvkInfrastrutureListComponent {
