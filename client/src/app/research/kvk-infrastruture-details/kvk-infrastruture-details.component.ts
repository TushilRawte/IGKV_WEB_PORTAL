...
@Component({
  selector: 'app-kvk-infrastruture-details',
  standalone: false,
  templateUrl: './kvk-infrastruture-details.component.html',
  styleUrls: ['./kvk-infrastruture-details.component.scss']
})
export class KvkInfrastrutureDetailsComponent {
  office_id!:string;
