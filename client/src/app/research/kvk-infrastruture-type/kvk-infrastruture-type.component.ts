...
@Component({
  selector: 'app-kvk-infrastruture-type',
  standalone: false,
  templateUrl: './kvk-infrastruture-type.component.html',
  styleUrls: ['./kvk-infrastruture-type.component.scss']
})
export class KvkInfrastrutureTypeComponent {
