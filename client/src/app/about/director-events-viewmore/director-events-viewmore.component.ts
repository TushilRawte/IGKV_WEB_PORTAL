...
@Component({
  selector: 'app-director-events-viewmore',
  standalone: false,
  templateUrl: './director-events-viewmore.component.html',
  styleUrls: ['./director-events-viewmore.component.scss']
})
export class DirectorEventsViewmoreComponent {
  ...
  ngOnInit(): void {
    ...
    setdetails_dir(){
      this.cms.setCatData(this.Office_Page_Data.office_name,'Event','','/research/director/' + this.unit_id + '/events')
    }
