...
@Component({
  selector: 'app-depart-events-viewmore',
  standalone: false,
  templateUrl: './depart-events-viewmore.component.html',
  styleUrls: ['./depart-events-viewmore.component.scss']
})
export class DepartEventsViewmoreComponent {
 ...
 // Extract the Subject_Id after 'about/college-home/college/'
        ...
        this.geteventdetails(this.Subject_Id);
