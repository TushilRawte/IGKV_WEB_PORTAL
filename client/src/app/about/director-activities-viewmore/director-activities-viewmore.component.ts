...
@Component({
  selector: 'app-director-activities-viewmore',
  standalone: false,
  templateUrl: './director-activities-viewmore.component.html',
  styleUrls: ['./director-activities-viewmore.component.scss']
})
export class DirectorActivitiesViewmoreComponent {
  ...
  ngOnInit(): void {
    ...
    setdetails_dir(){
      this.cms.setCatData(this.Office_Page_Data.office_name,'Activity','','/research/director/' + this.unit_id + '/activities')
    }
